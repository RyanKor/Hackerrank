...
first = int(input())
fisrt_variables = set(map(int, input().split()))
second = int(input())
second_variables = set(map(int, input().split()))

temp = fisrt_variables.union(second_variables)
result = sorted(temp - fisrt_variables.intersection(second_variables))
